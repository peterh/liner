...
// SetHistoryMode sets the pattern behavior when searching through the history. The default HistoryModePrefix where
// returned history items are matched by the string prefix.
